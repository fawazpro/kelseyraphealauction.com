...
<head>
    ...
    <link rel="shortcut icon" href="<?= base_url('assets/images/favicon/1.png')?>" type="image/x-icon">
    <title></title>
    ...
    <!-- Theme css -->
    <link rel="stylesheet" type="text/css" href="<?= base_url('assets/css/color19.css')?>" media="screen" id="color">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="header-contact">
                                <ul>
                                    <li>Welcome to KelseyRapheal</li>
                        ...
                        <div class="main-menu">
                            <div class="menu-left">
                                ...
                                <div class="brand-logo">
                                    <a href="index-2.html"><img width="179px" src="<?= base_url('assets/images/icon/logo/logo.png')?>"
                                    ...
                                    <div class="icon-nav d-none d-sm-block">
                                        <ul>
                                            <li class="onhover-div mobile-search">
                                                <div><img src="<?= base_url('assets/images/icon/search.png')?>" onclick="openSearch()"
                                                        class="img-fluid blur-up lazyload" alt=""> <i class="ti-search"
                                                        onclick="openSearch()"></i></div>
                                            </li>
                                            <li class="onhover-div mobile-setting">
                                                <div><img src="<?= base_url('assets/images/icon/setting.png')?>"
                                                        class="img-fluid blur-up lazyload" alt=""> <i
                                                        class="ti-settings"></i></div>
                                            </li>
                                            <li class="onhover-div mobile-cart">
                                                <div><img src="<?= base_url('assets/images/icon/cart.png')?>"
                                                        class="img-fluid blur-up lazyload" alt=""> <i
                        ...
                        <ul class="header-dropdown">
                            <li class="onhover-dropdown mobile-account"> <i class="fa fa-user" aria-hidden="true"></i>
                                ...
                                <ul class="onhover-show-div">
                                    <li><a href="<?= base_url('login')?>" data-lng="en">Login</a></li>
                                    <li><a href="<?= base_url('register')?>" data-lng="en">Register</a></li>
                                </ul>
                            </li>
                        </ul>
                    </div>
                ...
                <div class="col-sm-12">
                    <div class="main-menu">
                        <div class="menu-left">
                                                        ...
                                                        <div class="row m-0">
                                                            ...
                                                            <div class="col-xl-4">
                                                                <a href="#" class="mega-menu-banner"><img
                                                                        src="<?= base_url('assets/images/mega-menu/fashion')?>.jpg"
                            ...
                            <div class="brand-logo">
                                <a href="<?= base_url('/') ?>"><img src="<?= base_url('assets/images/icon/logo/logo.png')?>"
                                        class="img-fluid blur-up lazyload" alt="" width="179px"></a>
                            </div>
                        </div>
                        <div class="menu-right pull-right">
                            <div>
