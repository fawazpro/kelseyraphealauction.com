    ...
    <div class="slide-1 home-slider">
        <div>
            <div class="home text-left">
                <img src="<?= base_url('assets/images/electronics/8.jpg') ?>" alt="" class="bg-img blur-up lazyload">
                <div class="container-fluid custom-container">
                    <div class="row">
                        <div class="col">
                            <div class="slider-contain">
                                <div>
                                    <h4>Auction starts 10:00GMT</h4>
                                    <h1>Headset 4 all</h1>
        ...
        <div>
            <div class="home text-center">
                <img src="<?= base_url('assets/images/home-banner/12.jpg') ?>" alt="" class="bg-img blur-up lazyload">
                <div class="container-fluid custom-container">
                    <div class="row">
                        <div class="col">
                            <div class="slider-contain">
...
<div class="title1 section-t-space">
    <h4>special offer</h4>
    <h2 class="title-inner1">today's lot</h2>
</div>
<!-- Paragraph end -->
...
<section class="p-0">
    <div class="full-banner parallax text-center p-right">
        <img src="<?= base_url('assets/images/parallax/28.jpg') ?>" alt="" class="bg-img blur-up lazyload">
        <div class="container">
            <div class="row">
                <div class="col">
...
<div class="container">
    <section class="service border-section small-section">
        <div class="row">
            <div class="col-12 col-sm-4 service-block">
                <div class="media">
                    ...
                    <div class="media-body">
                        <h4>fast shipping</h4>
                        <p>We deliver anywhere, world wide</p>
                    </div>
                </div>
            </div>
            <div class="col-12 col-sm-4 service-block">
        ...
        <div class="row">
            <div class="col-md-12 p-0">
                ...
                <div class="slide-7 no-arrow slick-instagram">
                    <div>
                        <a href="#">
                            <div class="instagram-box"> <img src="../assets/images/slider/2.jpg" class="bg-img" alt="Avatar" style="width:100%">
                    ...
                    <div>
                        <a href="#">
                            <div class="instagram-box"> <img src="../assets/images/slider/3.jpg" class="bg-img" alt="Avatar" style="width:100%">
                                <div class="overlay"><i class="fa fa-instagram" aria-hidden="true"></i></div>
                            </div>
                        </a>
                    </div>
                    <div>
                        <a href="#">
                            <div class="instagram-box"> <img src="../assets/images/slider/4.jpg" class="bg-img" alt="Avatar" style="width:100%">
                                <div class="overlay"><i class="fa fa-instagram" aria-hidden="true"></i></div>
                            </div>
                        </a>
                    </div>
                    <div>
                        <a href="#">
                            <div class="instagram-box"> <img src="../assets/images/slider/9.jpg" class="bg-img" alt="Avatar" style="width:100%">
                                <div class="overlay"><i class="fa fa-instagram" aria-hidden="true"></i></div>
                            </div>
                        </a>
                    </div>
                    <div>
                        <a href="#">
                            <div class="instagram-box"> <img src="../assets/images/slider/6.jpg" class="bg-img" alt="Avatar" style="width:100%">
                                <div class="overlay"><i class="fa fa-instagram" aria-hidden="true"></i></div>
                            </div>
                        </a>
                    </div>
                    <div>
                        <a href="#">
                            <div class="instagram-box"> <img src="../assets/images/slider/7.jpg" class="bg-img" alt="Avatar" style="width:100%">
                                <div class="overlay"><i class="fa fa-instagram" aria-hidden="true"></i></div>
                            </div>
                        </a>
                    </div>
                    <div>
                        <a href="#">
                            <div class="instagram-box"> <img src="../assets/images/slider/8.jpg" class="bg-img" alt="Avatar" style="width:100%">
                                <div class="overlay"><i class="fa fa-instagram" aria-hidden="true"></i></div>
                            </div>
                        </a>
                    </div>
