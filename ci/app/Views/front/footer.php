            ...
            <div class="row footer-theme partition-f">
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="footer-contant">
                        ...
                        <p>This a dummy text you have to change! Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt
                    ...
                    <div class="sub-title">
                        ...
                        <div class="footer-contant">
                            <ul class="contact-list">
                                <li><i class="fa fa-map-marker"></i>Rayyan Auction Store, Demo store Sagamu, Ogun State
                                </li>
                                <li><i class="fa fa-phone"></i>Call Us: 08108097322</li>
                                <li><i class="fa fa-envelope-o"></i>Email Us: <a href="mailto:fawazpro27@gmail.com">fawazpro27@gmail.com</a></li>
